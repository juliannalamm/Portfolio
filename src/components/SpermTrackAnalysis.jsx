    ...
    return (
        <section id="sperm-track-results" className="flex justify-center px-4 md:px-8 lg:px-12 mt-16">
            ...
            <div className="max-w-7xl w-full bg-blue-100 rounded-sm overflow-hidden border border-gray-100 p-10 md:p-14">
                ...
                {/* Section Title */}
                <h2 className="text-3xl font-extrabold text-gray-900 leading-tight text-center">
                    Results & Analysis
                </h2>

                {/* Analysis Section */}
                <div className="mt-6">
                    <h3 className="text-2xl font-semibold text-gray-900 mb-3">Detection Analysis</h3>
                ...
                <div className="mt-10">
                    <h3 className="text-2xl font-semibold text-gray-900 mb-3">Tracker Performance</h3>
                    <p className="text-lg text-gray-800 leading-relaxed">
