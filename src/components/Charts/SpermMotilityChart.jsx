...
const SpermMotilityChart = () => {
  ...
  const traces = metrics.map((metric, i) => {
    ...
    let rawLabel = 'Raw Value';
    if (metric === 'Motility') rawLabel = 'Raw Motility (%)';
    else if (metric === 'Total Sperm') rawLabel = 'Raw Count (million)';
    else if (metric === 'TTP') rawLabel = 'Raw TTP (months)';
