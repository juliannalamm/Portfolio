...
const videoData = [
    ...
    { mp4: "/videos/tracks/intermediate.mp4", text: "A wavy, somewhat erratic path with moderate velocity and lower linearity. These sperm move forward but with frequent directional changes or head wobble, often falling short of progressive criteria.", caption: "Intermediate Movement" },
